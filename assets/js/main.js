...
/**
 * Dragging banner reaction.
 * @return {jQuery} jQuery object.
 */
$(function () {
  var $banner = $(".banner .slides"); // 只選擇 slides 來移動
  var startX = 0,
    endX = 0;
  var isDragging = false;
  var currentIndex = 0;
  var totalSlides = $(".slide").length; // 取得總投影片數量
  var slideWidth = $(".slide").outerWidth(true); // 取得每個投影片的寬度
  ...
  function updateSliderPosition() {
    ...
    $banner.css("transform", "translateX(" + newLeft + "px)");
  }
});
